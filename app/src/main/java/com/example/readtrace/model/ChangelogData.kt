    ...
    val versionHistory: List<ChangelogVersion> = listOf(
        ...
        ChangelogVersion(
            ...
            highlights = listOf(
                ...
                "📋 智能剪贴板嗅探：复制书名或豆瓣/Bangumi 链接切回 App，一键 0 误差收录〔已下线〕",
                "✍️ 一句话速记分词：「读完 三体 9分 #科幻」自动结构化入库，含 ISBN 扫码录入〔扫码已下线〕",
                ...
                "🎛️ 长按径向快捷环与全屏边缘侧滑返回，OLED 曜石真黑熄屏模式上线〔熄屏模式已下线〕",
                "🧪 思想炼金碰撞机与 432/528Hz 宇宙引力琴：跨媒介哲学对话即刻生成",
                "🌐 2.5D visionOS 空间标本盒展厅，与经典 3D 展厅双模共存〔两种展厅均已下线〕",
            ),
        ),
        ChangelogVersion(
            versionName = "v1.0.3",
        ...
        ChangelogVersion(
            ...
            highlights = listOf(
                ...
                "🎴 3D 陀螺仪视差画廊与实体藏书票 Ex-Libris 工坊〔视差画廊已下线〕",
